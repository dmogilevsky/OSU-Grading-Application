...
ActiveRecord::Schema.define(version: 2022_03_09_000302) do
  ...
  create_table "recommendations", force: :cascade do |t|
    ...
    t.index ["instructor_id", "student_id"], name: "index_recommendations_on_instructor_id_and_student_id", unique: true
  end
  ...
  add_foreign_key "graderassignments", "sections"
  add_foreign_key "graderassignments", "users", column: "student_id"
